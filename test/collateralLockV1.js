...
const CollateralLock = artifacts.require('./CollateralLockV1.sol')
...
contract('CollateralLock', async () => {
    ...
    describe('Unlock Refundable Collateral', async () => {
        ...
        it('should unlock refundable collateral after collateral was seized', async () => {
            // Expire Loan
            await helper.advanceTimeAndBlock(SECONDS_IN_DAY * 34)
            ...
            await collateralLock.unlockRefundableCollateral(1)

            const events = await collateralLock.getPastEvents('UnlockRefundableCollateral', {
                fromBlock: 0, toBlock: 'latest'
            })

            assert.equal(events[0].event, 'UnlockRefundableCollateral', 'UnlockRefundableCollateral event not emitted')
        })

        it('should unlock refundable collateral after seize period expired', async () => {
